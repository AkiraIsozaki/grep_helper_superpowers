...
| PL/SQL | `analyze_plsql.py` | ✅ CONSTANT 定数（case-insensitive） | — |
| TypeScript / JavaScript | `analyze_ts.py` | ✅ const 定数 | — |
| Python | `analyze_python.py` | ✅ ALL_CAPS モジュール定数 | — |
| Perl | `analyze_perl.py` | ✅ use constant / our \$ | — |
